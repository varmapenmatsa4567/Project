...
<body>
    ...
    <div class="ui container">
        <div class="ui inverted secondary pointing menu">
             ...
             <a class="active item" href="login.jsp"><i class="sign-in icon"></i>LOGIN</a>
      ...
      <br><br><br><br>
       <div class="myform">
       <h2><i class="sign-in icon"></i>Login</h2>
       <br>
      <form action="loginUser.jsp" class="was-validated ui form" method="post">
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="form-group col-10">
            <a href="forgotPas.jsp" class="ui blue button">Forgot Password?</a>
          </div>
        </div>
